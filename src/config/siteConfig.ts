...
export const siteConfig: SiteConfig = {
	title: "Ecydw",
	subtitle: "One love ecy website",
	siteURL: "https://ecydw.github.io/myblog/", // 请替换为你的站点URL，以斜杠结尾
	siteStartDate: "2026-06-11", // 站点开始运行日期，用于站点统计组件计算运行天数
	...
	bilibili: {
		vmid: "3546648951130283", // 在此处设置你的Bilibili用户ID (uid)，例如 "1129280784"
